...
$chaos->table('Products', 200)
    ...
    ->gen('when always set nameservice.value=getArray("array_nameService",keyservice.value)')       
		...
		->setInsert(false)
		->showTable(['IdProduct','name','stock','minStock','isService','idProductSubType','idContainer','idBrand','idService','unitPrice','margin','lastUpdate'],true)
		->run(true);
